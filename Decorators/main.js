...
let Employee = (() => {
    ...
    return class Employee {
        static {
            ...
            _tasks_decorators = [withTask({ name: "Task1", level: "medium" })];
        ...
        tasks = __runInitializers(this, _tasks_initializers, [{ name: "Task0", level: "hard" }]);
        extraTasks = (__runInitializers(this, _tasks_extraInitializers), []);
    };
})();
const employee = new Employee();
console.log(employee);
function withTask(task) {
    return function (target, contect) {
